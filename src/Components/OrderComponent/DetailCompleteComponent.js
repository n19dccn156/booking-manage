...
const DetailCompleteComponent = (props) => {
						...
						<div style={{ display: 'flex', flex: 1, flexDirection: 'row' }}>
							...
							<div style={{ display: 'flex', flex: 1, flexDirection: 'row' }}>
								...
								<div style={styles.inputContainer}>
									<Input value='Đã hoàn thành' style={{ height: 48, color: '#8c8c8c', fontSize: 16, textAlign: 'right', border: '2px dotted rgb(9, 88, 217)', fontWeight: 'bold' }} readOnly={true} />
								</div>
							</div>
						</div>
