...
const DetailAwaitComponent = React.memo((props) => {
						...
						<div style={{ display: 'flex', flex: 1, flexDirection: 'row' }}>
							...
							<div style={{ display: 'flex', flex: 1, flexDirection: 'row' }}>
								...
								<div style={styles.inputContainer}>
									<Input value='Chờ xác nhận' style={{ height: 48, color: '#8c8c8c', fontSize: 16, textAlign: 'right', border: '2px dotted rgb(9, 88, 217)', fontWeight: 'bold' }} readOnly={true} />
								</div>
							</div>
						</div>
				...
				<div style={{ display: 'flex', flexDirection: 'row' }}>
					<div style={{ display: 'flex', flex: 1, flexDirection: 'column' }}>
						<div style={{ display: 'flex', flex: 1, flexDirection: 'row' }}>
							...
							<div style={styles.inputContainer}>
								<Input value={props.id} style={{ height: 48, color: '#8c8c8c', fontSize: 16 }} maxLength={24} readOnly={true} />
							</div>
							<div>
								<div style={{ position: 'absolute', zIndex: 2, backgroundColor: 'white', marginLeft: 24, textDecoration: 'none', color: '#389e0d', fontWeight: 'bold' }}>
									Ngày đặt
...
export default DetailAwaitComponent;