...
const items2 = [
  {
    key: '0',
    label: (<Link to={'/order/await'} className='active'>Chờ xác nhận</Link>),
    //   children: `Content of Tab Pane 1`,
  },
  {
    key: '1',
    label: (<Link style={{color: 'black'}} to={'/order/comfirm'} className='active'>Đặt thành công</Link>),
...
const AwaitContainer = () => {
  ...
  return (
    <Content style={styleSheet.content}>
      <Tabs defaultActiveKey="0" type='line' tabBarExtraContent={element} items={items2} size='large' style={{ marginLeft: 32 }} onChange={onChange} />
