...
const items2 = [
  ...
  {
    key: '1',
    label: (<Link to={'/order/comfirm'}>Đặt thành công</Link>),
...
const ComfirmContainer = () => {
  ...
  return (
    <Content style={styleSheet.content}>
      <Tabs defaultActiveKey="1" type='line' tabBarExtraContent={element} items={items2} size='large' style={{ marginLeft: 32 }} onChange={onChange} />
